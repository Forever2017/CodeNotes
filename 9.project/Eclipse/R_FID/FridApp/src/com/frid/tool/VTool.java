...
public class VTool {
	...
	public static void InteractionBox(Context context,String title,String content,String noBut,String yesBut,String close,final CallbackVT cra) {
		...
		Interaction.setCloseClickListener(new OnSweetClickListener() {

			@Override
			public void onClick(SweetAlertDialog sweetAlertDialog) {
				//点击确认
				Interaction.dismissWithAnimation();
				cra.InteractionClose();
			}
		});
		Interaction.show();
	}
	...
	//输入密码验证
	public static void inputPassWordDialog(final Context context,final CallbackVT sm) {
		//新建自己风格的dialog
		final Dialog ADDdialog = new Dialog(context,R.style.MyDialog);
		ADDdialog.setContentView(R.layout.dialog_input);
		ADDdialog.show();
		...
		InputTitile.setText("设置密码");
		dialog_input_edit.setHint("请输入设置密码");
