...
import com.frid.adapter.QueryMItemOldAdapter;
import com.frid.adapter.QueryTableMItemOldAdapter;
 ...
 * 旧版 核对查询 
 * */
public class QueryFragmentOld extends FragmentJoker implements OnClickListener,OnItemClickListener{
	...
	private QueryTableMItemOldAdapter mAdapter;
	...
	private QueryMItemOldAdapter mItemAdapter;


	public QueryFragmentOld() { super(R.layout.fragment_query_old); }
